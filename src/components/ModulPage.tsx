    ...
    <div className="space-y-5 animate-slide-up">
      ...
      <div className="rounded-xl border border-[var(--border)] bg-[var(--bg-card)] p-6">
        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
          ...
          <div>
            <h3 className="text-sm font-semibold text-[var(--text-primary)] mb-1">Modul dalam pengembangan</h3>
            <p className="text-xs text-[var(--text-secondary)]">
              Dashboard overview sudah selesai. Fitur-fitur modul ini akan dibangun secara bertahap sesuai roadmap.
              Semua {fitur.length} fitur sudah dirancang dan siap untuk diimplementasikan.
            </p>
          </div>
        </div>
      </div>
